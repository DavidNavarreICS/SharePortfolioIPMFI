...
/**
 *
 * les actions simples sont des actions ! heritage --> donc (i) concretiser la
 * methode abstraire 'valeur' et (ii) def d'un constructeur cohérent avec le
 * constructeur parent
 */
public class ActionSimple extends Action {
    ...
    public void enrgCours(Jour j, float px) {
        /*
         * création d'un objet Cours associé au prix puis ajout dans la table en
         * indexant par le jour
         */
    ...
    /*
     * classee privée !! la classe n'est accessible que depuis la classe
     * englobante
     */
    private class Cours {
